...
class ComponentCore{
     ...
     * @var \Enola\Support\Generic\Request */
    public $request;
    /** Referencia al Response actual 
     * @var \Enola\Support\Generic\Response */
    public $response;
    /** 
     * 
     ...
     * @return boolean 
     */
    public function mapsComponents(En_HttpRequest $httpRequest){
     ...
     */
    public function executeUrlComponent(En_HttpRequest $httpRequest){        
        $uri_parts= explode("/", $httpRequest->uriApp);
        $name= "";
        $params= array();
        $action= NULL;
